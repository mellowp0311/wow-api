...
public class RaidController {
    ...
    @GetMapping("/participate/character")
    @ApiOperation(value = "케릭별 레이드 참여현황 목록 조회", response = Result.class)
    public ResponseWrap<List<RaidCharacter>> addRaidSchedule(@RequestParam(value = "userSeq") Long userSeq){
        return new ResponseWrap(raidService.searchRaidParticipateByCharacterList(userSeq));
    }
